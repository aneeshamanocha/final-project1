      ...
      if(counter > 0) {
        ...
        if(str4 == 'n') {
          ...
          while(numOfCardsPlacedDown > 4) {
            printf("You're trying to place too many cards. There are only four %ds in the deck. Try again.\n", currentCard);
            scanf("%d", &numOfCardsPlacedDown);
          }
